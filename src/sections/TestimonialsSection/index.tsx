...
export const TestimonialsSection = () => {
  return (
    <div className="items-center border-t-indigo-700/30 box-border caret-transparent flex flex-col max-w-[1440px] mx-auto w-full mt-5 py-10 border-t md:mt-0 md:py-[60px] md:border-t-black md:border-t-0">
