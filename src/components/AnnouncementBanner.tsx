  ...
  return (
    <div className="box-border caret-transparent">
                ...
                <div className="items-center box-border caret-transparent flex basis-[0%] flex-col grow justify-center w-full z-[1] md:basis-auto md:grow-0">
                  <div className="items-center box-border caret-transparent flex flex-col justify-center w-full md:w-auto">
                    ...
                    <div className="relative items-start bg-white box-border caret-transparent gap-x-1 flex flex-col justify-start gap-y-1 w-full overflow-hidden p-2.5 rounded-[25px] md:items-center md:flex-row md:w-auto md:pl-0 md:pr-2 md:py-0 md:rounded-full">
                      ...
                      <div className="bg-gray-200 box-border caret-transparent h-px w-full md:h-5 md:w-px"></div>
                      <div
                        type="text"
                        role="combobox"
                        className="bg-white box-border caret-transparent flex w-full overflow-hidden p-2 border-2 border-solid border-transparent md:w-[180px] md:pt-3.5 md:pb-4 md:px-6"
                      >
                        <div className="items-start box-border caret-transparent gap-x-2 flex basis-[0%] flex-row grow justify-start gap-y-2 w-full md:gap-x-[7px] md:flex-col md:justify-center md:gap-y-[7px] md:w-auto">
                          <div className="text-gray-500 text-xs font-medium box-border caret-transparent hidden tracking-[-0.24px] leading-[14px] min-h-0 min-w-0 md:block md:min-h-[auto] md:min-w-[auto]">
                            Location
                      ...
                      <div
                        title=""
                        className="bg-transparent box-content caret-black block min-h-0 min-w-0 w-auto p-0 md:aspect-auto md:bg-white md:box-border md:caret-transparent md:flex md:min-h-[auto] md:min-w-[auto] md:overscroll-x-auto md:overscroll-y-auto md:snap-align-none md:snap-normal md:snap-none md:decoration-auto md:underline-offset-auto md:w-[120px] md:overflow-hidden md:[mask-position:0%] md:bg-left-top md:pt-3.5 md:pb-4 md:px-6 md:scroll-m-0 md:scroll-p-[auto] md:border-2 md:border-solid md:border-transparent"
                      >
                        <div className="[align-items:normal] box-content caret-black gap-x-[normal] block basis-auto flex-row grow-0 justify-normal min-h-0 min-w-0 gap-y-[normal] md:items-start md:aspect-auto md:box-border md:caret-transparent md:gap-x-[7px] md:flex md:basis-[0%] md:flex-col md:grow md:justify-center md:min-h-[auto] md:min-w-[auto] md:overscroll-x-auto md:overscroll-y-auto md:gap-y-[7px] md:snap-align-none md:snap-normal md:snap-none md:decoration-auto md:underline-offset-auto md:[mask-position:0%] md:bg-left-top md:scroll-m-0 md:scroll-p-[auto]">
                          <div className="text-black text-base font-normal box-content caret-black tracking-[normal] leading-[normal] min-h-0 min-w-0 md:text-gray-500 md:text-xs md:font-medium md:aspect-auto md:box-border md:caret-transparent md:tracking-[-0.24px] md:leading-[14px] md:min-h-[auto] md:min-w-[auto] md:overscroll-x-auto md:overscroll-y-auto md:snap-align-none md:snap-normal md:snap-none md:decoration-auto md:underline-offset-auto md:[mask-position:0%] md:bg-left-top md:scroll-m-0 md:scroll-p-[auto]">
                            Date
                          </div>
                          <div className="[align-items:normal] box-content caret-black gap-x-[normal] block min-h-0 min-w-0 gap-y-[normal] md:items-center md:aspect-auto md:box-border md:caret-transparent md:gap-x-1 md:flex md:min-h-[auto] md:min-w-[auto] md:overscroll-x-auto md:overscroll-y-auto md:gap-y-1 md:snap-align-none md:snap-normal md:snap-none md:decoration-auto md:underline-offset-auto md:[mask-position:0%] md:bg-left-top md:scroll-m-0 md:scroll-p-[auto]">
                            <input
                              placeholder="Anytime"
                              type="text"
                              value=""
                              className="text-black text-[13.3333px] font-normal bg-white box-content caret-black inline-block tracking-[normal] leading-[normal] min-h-0 min-w-0 pointer-events-auto w-auto md:appearance-none md:text-zinc-900 md:text-sm md:font-bold md:aspect-auto md:bg-transparent md:box-border md:caret-transparent md:block md:tracking-[-0.28px] md:leading-[14px] md:min-h-[auto] md:min-w-[auto] md:overscroll-x-auto md:overscroll-y-auto md:pointer-events-none md:snap-align-none md:snap-normal md:snap-none md:decoration-auto md:underline-offset-auto md:w-full md:[mask-position:0%] md:bg-left-top md:p-0 md:scroll-m-0 md:scroll-p-[auto]"
                            />
                          </div>
                        </div>
                      </div>
            ...
            <section className="[mask-image:radial-gradient(115.24px_at_50%_137.5px,rgb(0,0,0)_99%,rgba(0,0,0,0)_101%),radial-gradient(115.24px_at_50%_-112.5px,rgba(0,0,0,0)_99%,rgb(0,0,0)_101%),radial-gradient(115.24px_at_50%_calc(100%_-_137.5px),rgb(0,0,0)_99%,rgba(0,0,0,0)_101%),radial-gradient(115.24px_at_50%_calc(100%_+_112.5px),rgba(0,0,0,0)_99%,rgb(0,0,0)_101%)] relative items-center bg-violet-950 box-border caret-transparent flex flex-col justify-center mb-[-50px] mt-[-50px] [mask-clip:border-box,border-box,border-box,border-box] [mask-composite:add,add,add,add] [mask-mode:match-source,match-source,match-source,match-source] [mask-origin:border-box,border-box,border-box,border-box] [mask-repeat:repeat-x,repeat-x,repeat-x,repeat-x] [mask-size:100px_51%,100px_calc(51%_-_25px),100px_51%,100px_calc(51%_-_25px)] max-w-[375px] z-[3] px-[4%] py-[50px] md:[mask-image:radial-gradient(182px_at_50%_225px,rgb(0,0,0)_99%,rgba(0,0,0,0)_101%),radial-gradient(182px_at_50%_-175px,rgba(0,0,0,0)_99%,rgb(0,0,0)_101%),radial-gradient(182px_at_50%_calc(100%_-_225px),rgb(0,0,0)_99%,rgba(0,0,0,0)_101%),radial-gradient(182px_at_50%_calc(100%_+_175px),rgba(0,0,0,0)_99%,rgb(0,0,0)_101%)] md:mb-[-75px] md:mt-[-75px] md:[mask-size:200px_51%,200px_calc(51%_-_50px),200px_51%,200px_calc(51%_-_50px)] md:max-w-screen-xl md:py-[75px]">
              <div className="items-center box-border caret-transparent gap-x-[17px] flex justify-center max-w-[1440px] gap-y-[17px] w-full">
                ...
                <div className="text-white text-lg font-bold box-border caret-transparent tracking-[-0.18px] leading-[28.8px] text-center">
                  Over 4 million ⭐⭐⭐⭐⭐ experiences hosted by 15,000 hosts
                  and counting!
                </div>
                        ...
                        <div className="box-border caret-transparent flex float-left min-h-px w-full overflow-hidden">
                          <div className="box-border caret-transparent flex w-full mx-1 pt-0 pb-[18px] md:w-auto md:mx-0 md:pt-[50px]">
                            <div className="items-center bg-white shadow-[rgba(0,0,0,0.03)_12px_18px_0px_0px] box-border caret-transparent flex flex-col max-w-full mx-0 px-4 py-5 rounded-3xl md:max-w-[415px] md:mx-3 md:px-10 md:py-11">
                              ...
                              <div className="text-neutral-800 text-sm font-medium box-border caret-transparent tracking-[-0.14px] leading-[19.6px] text-center md:text-lg md:tracking-[-0.18px] md:leading-[28.8px]">
                                Used it for my daughter&#39;s birthday—great
                                host, big pool, trampoline, privacy. Will book
                                again!
                              </div>
                            </div>
                          </div>
            ...
            <section className="items-center box-border caret-transparent flex flex-col justify-center max-w-[375px] px-[max(2%,18px)] py-[35px] md:max-w-screen-xl md:px-[4%] md:py-[65px]">
              <div className="items-center box-border caret-transparent flex flex-col max-w-[1440px] w-full">
                ...
                <div className="text-gray-500 text-base font-medium box-border caret-transparent tracking-[-0.24px] leading-[22px] text-center mb-9 md:text-2xl md:leading-[38.4px]">
                  Enjoy a variety of joy filled spaces, always unique, always
                  your own
                </div>
                ...
                <div className="relative items-center box-border caret-transparent gap-x-0 flex flex-col gap-y-0 w-full md:gap-x-[170px] md:gap-y-[170px] md:w-4/5">
                  ...
                  <div className="items-center box-border caret-transparent gap-x-4 grid [grid-template-areas:'image''content'] grid-cols-[1fr] justify-center gap-y-4 w-full mb-6 pb-6 border-b-black/10 border-b md:gap-x-8 md:[grid-template-areas:'content_image'] md:grid-cols-[1fr_1fr] md:gap-y-8 md:mb-0 md:pb-0 md:border-b-black md:border-b-0">
                    <div className="box-border caret-transparent col-end-[content] col-start-[content] row-end-[content] row-start-[content] w-full">
                      ...
                      <div className="text-gray-500 text-sm font-medium box-border caret-transparent tracking-[-0.14px] leading-[19.6px] text-center md:text-2xl md:tracking-[-0.24px] md:leading-[33.6px] md:text-start">
                        Whether it’s a solo unwind, family hangout, or party
                        with friends, the space is all yours for the time you
                        booked. No sharing. No strangers.
                      </div>
                    </div>
                    <div className="relative aspect-[3_/_2] box-border caret-transparent col-end-[image] col-start-[image] row-end-[image] row-start-[image] transform-none w-full overflow-hidden rounded-[20px] md:rotate-[3.0000011085596214deg]">
                      <img
                  ...
                  <div className="items-center box-border caret-transparent gap-x-4 grid flex-row [grid-template-areas:'image''content'] grid-cols-[1fr] justify-center gap-y-4 w-full md:gap-x-8 md:flex-row-reverse md:[grid-template-areas:'image_content'] md:grid-cols-[1fr_1fr] md:gap-y-8">
                    <div className="box-border caret-transparent col-end-[content] col-start-[content] row-end-[content] row-start-[content] w-full">
                      ...
                      <div className="text-gray-500 text-sm font-medium box-border caret-transparent tracking-[-0.14px] leading-[19.6px] text-center md:text-2xl md:tracking-[-0.24px] md:leading-[33.6px] md:text-start">
                        Leave the pool as you found and with quick review to
                        help the next guest. Then? Book again so you can count
                        down till your next Swimply!
                      </div>
                    </div>
                    <div className="relative aspect-[3_/_2] box-border caret-transparent col-end-[image] col-start-[image] row-end-[image] row-start-[image] transform-none w-full overflow-hidden rounded-[20px] md:rotate-[-3.0000011085596214deg]">
                      <img
                  ...
                  <div className="box-border caret-transparent flex basis-[0%] flex-col grow w-full md:w-auto">
                      ...
                      <div className="box-border caret-transparent">
                        ...
                        <div className="box-border caret-transparent h-0 w-full overflow-hidden">
                          <p className="text-zinc-800 text-sm box-border caret-transparent leading-[22.4px] pb-[23px] md:text-lg md:leading-[28.8px] md:pb-[12.8px]">
                            ...
                            />
                            Instant Book icon are confirmed immediately. -
                            Others require host approval (you’ll hear back
                            within 24 hours). You’re only charged once the
                            booking is confirmed. Once confirmed you will get
                            all the information you need including the address,
                            how to enter and how to exit and anything else
                            you’ll need to enjoy your swim!
                          </p>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="box-border caret-transparent">
                        ...
                        <div className="box-border caret-transparent h-0 w-full overflow-hidden">
                          <p className="text-zinc-800 text-sm box-border caret-transparent leading-[22.4px] pb-[23px] md:text-lg md:leading-[28.8px] md:pb-[12.8px]">
                            ...
                            listings even offer premium amenities and
                            experiences for an additional cost.
                          </p>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="box-border caret-transparent">
                        ...
                        <div className="box-border caret-transparent h-0 w-full overflow-hidden">
                          <p className="text-zinc-800 text-sm box-border caret-transparent leading-[22.4px] pb-[23px] md:text-lg md:leading-[28.8px] md:pb-[12.8px]">
                            ...
                            extra guests for a fee. All this information is
                            listed clearly on every pools profile.
                          </p>
                        </div>
                      </div>
                    </div>
                    <div className="box-border caret-transparent mb-4 pb-4 border-b-black/10 border-b md:mb-5 md:pb-5">
                      <div className="box-border caret-transparent">
                        ...
                        <div className="box-border caret-transparent h-0 w-full overflow-hidden">
                          <p className="text-zinc-800 text-sm box-border caret-transparent leading-[22.4px] pb-[23px] md:text-lg md:leading-[28.8px] md:pb-[12.8px]">
                            95% of Swimplys offer restroom access. Restroom
                            access and info is listed on every profile.
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="box-border caret-transparent flex basis-[0%] flex-col grow w-full md:w-auto">
                    ...
                    <div className="box-border caret-transparent mb-4 pb-4 border-b-black/10 border-b md:mb-5 md:pb-5">
                      <div className="box-border caret-transparent">
                        ...
                        <div className="box-border caret-transparent h-0 w-full overflow-hidden">
                          <p className="text-zinc-800 text-sm box-border caret-transparent leading-[22.4px] pb-[23px] md:text-lg md:leading-[28.8px] md:pb-[12.8px]">
                            Some hosts allow pets, others don’t. Check the
                            listing for pet policies, or message the host
                            directly. Look out for listings with a dedicated Pet
                            Swim option — perfect for dogs!
                          </p>
                        </div>
                      </div>
                    </div>
                    <div className="box-border caret-transparent mb-4 pb-4 border-b-black/10 border-b md:mb-5 md:pb-5">
                      <div className="box-border caret-transparent">
                        ...
                        <div className="box-border caret-transparent h-0 w-full overflow-hidden">
                          <p className="text-zinc-800 text-sm box-border caret-transparent leading-[22.4px] pb-[23px] md:text-lg md:leading-[28.8px] md:pb-[12.8px]">
                            For $19.99 per month, the Premium Pass offers
                            benefits like $0 service fees on bookings up to
                            $250, $0 cancellation fees, priority support, and
      ...
      <footer className="relative bg-slate-800 box-border caret-transparent gap-x-[60px] grid [grid-template-areas:'logo''links''apps''social''region''copy'] grid-cols-[1fr] gap-y-[50px] z-[5] pt-12 pb-[110px] px-8 md:[grid-template-areas:'logo_logo_logo''links_apps_social''copy_copy_region'] md:grid-cols-[3fr_1fr_1fr] md:pt-[51.2px] md:pb-[83.2px] md:px-[50px]">
        ...
        <div className="relative box-border caret-transparent basis-[0%] col-end-[apps] col-start-[apps] row-end-[apps] row-start-[apps] before:accent-auto before:caret-transparent before:text-black before:block before:text-base before:not-italic before:normal-nums before:font-normal before:h-auto before:tracking-[normal] before:leading-[normal] before:list-outside before:list-disc before:pointer-events-auto before:absolute before:text-start before:indent-[0px] before:normal-case before:top-[-25px] before:visible before:w-full before:border-separate before:left-0 before:font-nunito_199a07 before:md:h-full before:md:left-[-30px] before:md:w-auto before:md:top-0 after:accent-auto after:bottom-[-30px] after:caret-transparent after:text-black after:block after:text-base after:not-italic after:normal-nums after:font-normal after:h-auto after:tracking-[normal] after:leading-[normal] after:list-outside after:list-disc after:pointer-events-auto after:absolute after:right-[-30px] after:text-start after:indent-[0px] after:normal-case after:visible after:w-full after:border-separate after:left-0 after:top-auto after:font-nunito_199a07 after:md:h-full after:md:w-auto after:md:left-auto after:md:top-0 after:md:bottom-auto">
          <p className="text-white text-sm font-medium box-border caret-transparent leading-[21px] mb-[15px] md:mb-5">
            Download the Swimply App
          </p>
          <div className="box-border caret-transparent gap-x-[5px] flex flex-row gap-y-[5px] md:gap-x-[18px] md:flex-col md:gap-y-[18px]">
            <a
              href="https://swimply.onelink.me/f5eH/t1k5sgxb"
              aria-label="Download the apple app"
              className="relative aspect-[150_/_40] box-border caret-transparent block h-10 w-[150px] border border-gray-200 overflow-hidden rounded-lg border-solid"
            >
              <img
                alt="apple"
                src="https://c.animaapp.com/mhktpn46U9Eif8/assets/app-store.png"
                className="text-transparent aspect-[auto_150_/_40] box-border h-10 w-[150px]"
              />
            </a>
            <a
              href="https://swimply.onelink.me/f5eH/t1k5sgxb"
              aria-label="Download the google app"
              className="relative aspect-[150_/_40] box-border caret-transparent block h-10 w-[150px] border border-gray-200 overflow-hidden rounded-lg border-solid"
            >
              <img
                alt="google"
                src="https://c.animaapp.com/mhktpn46U9Eif8/assets/google-play.png"
                className="text-transparent aspect-[auto_150_/_40] box-border h-10 w-[150px]"
              />
            </a>
          </div>
        ...
        <div className="items-end box-border caret-transparent gap-x-[34px] flex basis-[0%] flex-col-reverse grow flex-wrap-reverse col-end-[copy] col-start-[copy] row-end-[copy] row-start-[copy] gap-y-3 md:items-center md:flex-row">
          <p className="text-white text-sm box-border caret-transparent flex my-3.5">
        ...
        <div className="relative items-end box-border caret-transparent flex col-end-[region] col-start-[region] row-end-[region] row-start-[region] justify-end">
          <button
            type="button"
          ...
          >
            USA (English)
            <img
              src="https://c.animaapp.com/mhktpn46U9Eif8/assets/icon-66.svg"
              alt="Icon"
